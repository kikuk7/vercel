...
async function fetchPages() {
  try {
    ...
    if (!response.ok) throw new Error('Gagal mengambil daftar halaman.');
...
.table-striped > tbody > tr:nth-of-type(odd) > * { --bs-table-accent-bg: #f2f2f2; } /* Warna striping */
.table-hover > tbody > tr:hover > * { --bs-table-accent-bg: rgba(0,0,0,.075); } /* Warna hover */
