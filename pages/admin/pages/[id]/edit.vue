    ...
    <div class="card shadow-sm mt-4">
      ...
      <div class="card-body">
        <form @submit.prevent="updatePage">
          ...
          <!-- Bagian ini sudah dihapus di sini karena ada halaman edit kontak terpisah -->
...
Tentu, saya memahami. Anda ingin memodifikasi halaman edit umum (`pages/admin/pages/[id]/edit.vue`) agar halaman-halaman seperti Beranda, Tentang Kami, Layanan Kami, dan Kontak memiliki fungsionalitas untuk **mengunggah, melihat pratinjau, dan menghapus gambar** yang spesifik untuk halaman tersebut. Anda ingin ini mirip dengan tampilan galeri yang sudah ada.

Berikut adalah perbaikan pada file `D:\cvsumberalam\CVSUMBERALAM\pages\admin\pages\[id]\edit.vue`. Saya akan menambahkan bagian manajemen gambar dengan input file, tombol unggah, pratinjau thumbnail, dan tombol hapus/pindah untuk gambar-gambar spesifik halaman ini. Bagian ini akan muncul di blok `v-if` yang relevan untuk setiap slug halaman (beranda, tentang, layanan).
